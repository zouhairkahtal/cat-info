  ...
  return (
    <>
      ...
      >
        ...
        <motion.div initial={{opacity:0,x:-200}} animate={{opacity:100,x:0}} transition={{duration:1,ease:"easeInOut",delay:0.2}} className="w-[600px] h-[500px] bg-orange-500 text-white flex flex-col justify-center items-start p-10 rounded-r-3xl shadow-lg max-[1175px]:shadow-none max-[1175px]:bg-opacity-40 max-[1175px]:bg-white  max-[400px]:bg-transparent ">
